...
SlimeEnemy::SlimeEnemy()
{
	...
	static ConfigManager::EnemyTemplate& enemy_template = ConfigManager::instance()->slime_template;
...
void SlimeEnemy::attack(double delta)
{
...
void SlimeEnemy::is_dead()
{
	attack_box->set_enable(false);
}

void SlimeEnemy::finish_attack()
{
	attack_box->set_enable(false);
	Enemy::finish_attack();
}