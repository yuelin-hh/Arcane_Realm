			...
			while (true)
			{
				...
				else if (distance.x <= 0.000001 && distance.x >= -0.000001)
				{
					...
					if (flag)
					{
						...
						temp_distance.y = (i_dst * 32 - 16 * get_symbol(distance.y) + 16) - (box->get_position().y + box->get_size().y / 2 * get_symbol(distance.y)) - get_symbol(distance.y);
				...
				else if (distance.y <= 0.000001 && distance.y >= -0.000001)
				{
					...
					{
						Vector2 temp_distance;
						temp_distance.x = (j_dst * 32 - 16 * get_symbol(distance.x) + 16) - (box->get_position().x + box->get_size().x / 2 * get_symbol(distance.x)) - get_symbol(distance.x);
				...
				else
				{
					...
					y_time = ((i_dst * 32 - 16 * get_symbol(distance.y) + 16) - (box->get_position().y + box->get_size().y / 2 * get_symbol(distance.y)) - get_symbol(distance.y)*2) / box->get_velocity().y / 32;
					...
					x_time = ((j_dst * 32 - 16 * get_symbol(distance.x) + 16) - (box->get_position().x + box->get_size().x / 2 * get_symbol(distance.x)) - get_symbol(distance.x)*2) / box->get_velocity().x / 32;
